...
class A2C(agent.AttributeSavingMixin, agent.BatchAgent):
    ...
    def update(self):
        ...
        # print("Number of Advantages:", len(advantages))

        # Note: 
        # - len(advantages) == nsteps
        # - num_processes == num_envs
        self.n_updates += len(advantages) * self.num_processes
