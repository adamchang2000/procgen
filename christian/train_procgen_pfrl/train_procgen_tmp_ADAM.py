...
def parse_args():
    ...
    parser.add_argument('--impala_layer_init', type=int, help='somewhere between 0 and 14 (inclusive)')
    parser.add_argument('--init_style', type=str, default='resize', help='choose: [resize, fragment]')
